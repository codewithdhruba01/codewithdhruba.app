  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-white py-16 px-4 flex flex-col items-center">
      ...
      <ScrollReveal className="text-center flex flex-col items-center">
        <h1 className="text-4xl font-bold mb-5 font-excon">
          Get in Touch
        </h1>
        <p className="text-gray-400 mb-10 pb-5 text-center max-w-md font-satoshi">
          Have a question or want to Chat with my assistant below.
        </p>
      </ScrollReveal>

      <ScrollReveal delay={0.1} className="w-full max-w-xl">
        <div className="w-full bg-neutral-900 rounded-lg shadow-xl p-4 space-y-4">
          {/* Assistant Header */}
      ...
      <div className="mt-10 text-center">
        <ScrollReveal delay={0.15}>
          <h3 className="text-xl font-bold text-white mb-5 font-synonym">
