...
export default function AboutMe() {
  return (
    ...
    >
      <div className="max-w-3xl mx-auto w-full px-6 flex flex-col gap-10">
        ...
        <ScrollReveal delay={0.15}>
          <div className="bg-[#101010] border border-neutral-800 rounded-2xl p-6 shadow-lg text-left max-w-md">
