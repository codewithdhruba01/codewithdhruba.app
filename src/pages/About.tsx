...
export default function AboutMe() {
  return (
    <section id="about" className="min-h-screen bg-[#0A0A0A] text-white flex flex-col items-center justify-center px-4 py-12" data-aos="fade-up">
      <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* Left Profile Card */}
        <div className="bg-[#111] rounded-2xl p-4 flex flex-col items-center shadow-lg" data-aos="zoom-in">
          <img
        ...
        <div className="md:col-span-2 flex flex-col gap-6">
          <h1 className="text-4xl font-bold">About <span className="text-[#00DC82]">Me</span></h1>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <strong className="text-[#949494]">Bachelor of Computer Application</strong><br />
                Swami Vivekananda University Kolkata <span className="text-[#00DC82]">( 2023 - Present )</span>
              </li>
            </ul>
          </div>
        </div>
