  ...
  return (
    <section id="get-in-touch" className="py-20 bg-neutral-950">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Heading */}
        <div className="mb-8">
            <h2 className="text-3xl font-bold text-white items-center text-center font-excon">Development</h2>
          <p className="text-lg text-neutral-400 font-outfit text-center">Tools</p>
        </div>
