    ...
    <footer className="bg-neutral-950 border-t border-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a
                ...
                className="p-2 bg-gray-800 hover:bg-gray-200 rounded-lg transition-colors"
              >
                <Github className="w-5 h-5 text-gray-200 hover:text-black" />
              </a>
              <a
                href="https://www.linkedin.com/in/dhrubaraj-pati/"
                className="p-2 bg-gray-800 hover:bg-[#0162fe] rounded-lg transition-colors"
              >
                <Linkedin className="w-5 h-5 text-gray-400 hover:text-white" />
              </a>
              <a
                href="https://x.com/codewithdhruba"
                className="p-2 bg-gray-800 hover:bg-[#007eb8] rounded-lg transition-colors"
              >
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-bold font-poppins text-white mb-4">Quick Links</h3>
            <ul className="space-y-1">
              <li>
                <a
                  href="/#projects"
                  className="text-neutral-400 hover:text-green-400 transition-colors font-poppins"
                >
                  Project
                </a>
              </li>
          ...
          <div>
            <h3 className="text-lg font-bold font-poppins text-white mb-4">Pages</h3>
            <ul className="space-y-1">
              <li>
                <a
                  href="/about"
