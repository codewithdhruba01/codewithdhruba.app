    ...
    >
      <div className="max-w-4xl mx-auto w-full px-6 flex flex-col">
        ...
        <div className="relative px-4 flex justify-between items-end -mt-10 sm:-mt-12 md:-mt-14 z-10">
          {/* Avatar */}
          <div className="relative w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 rounded-full overflow-hidden border-4 border-[#0A0A0A] bg-neutral-900 shadow-md">
            <img
        ...
        <div className="px-1">
          ...
          <p className="text-neutral-400 leading-relaxed text-base">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded bg-[#171717] border border-neutral-800 text-neutral-200 hover:text-white transition duration-200"
            >
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded bg-[#171717] border border-neutral-800 text-neutral-200 hover:text-white transition duration-200"
            >
              <svg viewBox="0 0 128 128" className="w-3.5 h-3.5 bg-white rounded-full">
