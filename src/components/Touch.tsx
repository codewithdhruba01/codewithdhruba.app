  ...
  return (
    <section id="get-in-touch" className="pt-2 pb-16 md:pt-4 md:pb-20 bg-background">
      <div className="max-w-3xl mx-auto w-full px-6">
        <div className="pt-0">
          <ScrollReveal>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight text-foreground font-bricolage leading-none">
              Working on something?
              <span className="block text-muted-foreground mt-2">Let's build it.</span>
            </h2>
            <p className="mt-4 text-muted-foreground font-hanken text-sm sm:text-base max-w-lg leading-relaxed">
            ...
            <div className="flex flex-wrap items-center gap-6 mt-8">
              ...
              <motion.button
                ...
                className="group relative flex items-center px-5 py-2 bg-card border border-border rounded-xl hover:bg-accent transition-all duration-300 shadow-sm overflow-hidden cursor-pointer"
              >
                ...
                >
                  <div className="flex items-center gap-1.5">
                    <Plus className="text-muted-foreground w-3 h-3 shrink-0" strokeWidth={3} />
                ...
                {/* Always visible text */}
                <span className="text-foreground font-outfit font-bold text-sm whitespace-nowrap transition-colors duration-300 ml-2">
                  Book a Free Call
                </span>
              </motion.button>
