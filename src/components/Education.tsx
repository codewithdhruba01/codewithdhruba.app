  ...
  const education = [
    {
      ...
      description:
        "Currently pursuing my bachelor's degree with a focus on computer science fundamentals and modern web technologies.",
    },
    {
      year: '2020 - 2022',
      ...
      description:
        'Completed My higher secondary education with Computer Application.',
    },

    {
      ...
      description:
        'Completed my secondary education in West Bengal Board of Secondary Education Board.',
    },
  ];
